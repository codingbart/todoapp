...
\title{\LARGE\bfseries Kamień Milowy I -- Analiza i Projekt Systemu\\[0.8cm]
  {\Large Aplikacja do zarządzania zadaniami (Todo App)}}
\author{Bartłomiej Karkoszka \and Rafał Grot \and Filip Stępień}
\date{Grupa: 1ID21A\\Przedmiot: MASI}
...
\begin{itemize}
  ...
  \item \textbf{Użytkownik} po zalogowaniu ma dostęp do pełnej funkcjonalności: zarządzania zadaniami i~dashboardu.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{11cm} l}
    ...
    System umożliwia przypisanie priorytetu do zadania                                             & Wysoki             \\
    \bottomrule
  \end{tabular}
\end{table}
